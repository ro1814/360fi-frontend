  ...
  return (
    <div className="firstDivInsight">
      ...
      <p className="firstPInsight">
        We are always looking to provide valuable information to our clients and
        target audience. In this section, you can find the latest news about
        what we have been doing at 360 Fund Insight – ranging from analytical
        reports on specific fund groups, to general updates about the company
      </p>
      <div className="insightNewsFeedDiv">
        <div className="insightCardNew rounded shadow">
          ...
          <a className="newsTitle" href={firstNewsLink} target="_blank">
            Finding Fair Value in European Small Caps Funds – ACE Score Analysis
          </a>
        </div>
        <div className="insightCardNew rounded shadow">
        ...
        <div className="insightCardNew rounded shadow">
          ...
          <a className="newsTitle" href={thirdNewsLink} target="_blank">
            Fund Corporate Actions – How do you keep up with all the changes and
            communication?
          </a>
        </div>
      </div>
